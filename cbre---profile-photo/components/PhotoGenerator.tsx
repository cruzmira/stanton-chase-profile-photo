              ...
              <div className="flex flex-col items-center relative order-2 lg:order-1">
                ...
                {!isLoading && (
                  <div className="mt-8 w-full max-w-[340px] space-y-5">
                    {/* Style Selector — always visible while a photo is present */}
                    <div>
                    ...
                    {/* Generate / Regenerate Button — same source photo is kept */}
                    <button
                    ...
                    >
                      <span className="relative z-10 flex items-center">
                        ...
                        {generatedImage ? t.regenerate : t.generate}
                      </span>
                      <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                    </button>

                    {/* Take new photo button — explicit reset (only after generation, otherwise Back works) */}
                    {generatedImage && (
                      <button
                        onClick={resetAll}
                        className="w-full py-3 bg-white border border-gray-200 text-gray-600 text-sm font-semibold rounded-xl hover:border-[#1054cc] hover:text-[#1054cc] transition-all flex items-center justify-center gap-2"
                      >
